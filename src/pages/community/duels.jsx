...
const CommunityDuels = () => {
  ...
  useEffect(() => {
    const leaderboardRef = query(
      ref(database, 'users'),
      orderByChild('stats/duels/rating'),
    );
    ...
    <div className="min-h-screen bg-[#F0EFEB] text-[#1a1a1a] font-sans">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#EB3514]/10 text-[#EB3514] mb-4">
            <Swords size={16} />
            <span className="text-sm font-medium">Duels Leaderboard</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight mb-3">Community Rankings</h1>
          <p className="text-gray-500 max-w-md mx-auto">
            Face off against other players in real-time verb conjugation battles
          </p>
        </div>

        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-2xl border border-[#DEDDDA] p-6 text-center">
            <div className="w-12 h-12 rounded-xl bg-[#EB3514]/10 flex items-center justify-center mx-auto mb-3">
              <Target size={24} className="text-[#EB3514]" />
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#DEDDDA] p-6 text-center">
            <div className="w-12 h-12 rounded-xl bg-[#EB3514]/10 flex items-center justify-center mx-auto mb-3">
              <TrendingUp size={24} className="text-[#EB3514]" />
            </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-[#DEDDDA] p-12 text-center">
            ...
            <p className="text-gray-500">Be the first to play Duels and claim the top spot!</p>
          </div>
        ) : (
          <>
                  ...
                  >
                    ...
                    <div className="col-span-2 text-right">
                      <span className={`text-sm font-medium ${
                        (player.wins / player.games) >= 0.5 ? 'text-green-600' : 'text-gray-600'
                      }`}>
